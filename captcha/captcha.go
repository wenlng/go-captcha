...
func NewCaptcha() *Captcha {
	log.Println(fmt.Sprintf("\x1b[%dm%s\x1b[0m", 93, "************* Version Upgrade *************"))
	log.Println(fmt.Sprintf("\x1b[%dm%s\x1b[0m", 93, "The current v1 version will be officially removed after v2.1, Please upgrade to v2 version as soon as possible, https://github.com/wenlng/go-captcha"))
	log.Println(fmt.Sprintf("\x1b[%dm%s\x1b[0m", 93, "*******************************************"))
